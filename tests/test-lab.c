...
//     char *argv1[] = {"./myprogram"};
//     int argc1 = 1;
//     parse_args(argc1, argv1);
//     TEST_ASSERT_EQUAL_INT(0, flags);
//     TEST_ASSERT_NULL(cvalue);

//     // Test case 2: Version flag
//     char *argv2[] = {"./myprogram", "-v"};
//     int argc2 = 2;
//     parse_args(argc2, argv2);
//     TEST_ASSERT_TRUE(flags & FLAG_VERSION);
//     TEST_ASSERT_NULL(cvalue);
...
//     // Test case 3: Debug flag and custom prompt
//     char *argv3[] = {"./myprogram", "-d", "-c", "foo> "};
//     int argc3 = 4;
//     parse_args(argc3, argv3);
//     TEST_ASSERT_TRUE(flags & FLAG_DEBUG);
//     TEST_ASSERT_EQUAL_STRING("foo> ", cvalue);
...
//     char *argv4[] = {"./myprogram", "-e"};
//     int argc4 = 2;
//     parse_args(argc4, argv4);
//     TEST_ASSERT_EQUAL_INT(0, flags);
//     TEST_ASSERT_NULL(cvalue);
// }
